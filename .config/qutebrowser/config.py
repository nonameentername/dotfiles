...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-6>': '<Ctrl-^>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Shift-Enter>': '<Return>', '<Enter>': '<Return>', '<Ctrl-J>': '<Return>', '<Ctrl-M>': '<Return>', '<Shift-Return>': '<Return>', '<Ctrl-[>': '<Escape>'}
...
## Type: Dict
# c.content.javascript.log = {'unknown': 'debug', 'warning': 'debug', 'error': 'debug', 'info': 'debug'}
